...
export default function WalletPage() {
  ...
  const walletAddress = user?.walletAddress || "0xDefaultWalletAddress1234567890abcdef"
  ...
  const handleDisconnect = useCallback(() => {
    logout()
    router.push("/") // Redireciona para a página inicial após desconectar
  }, [logout, router])
  ...
  const handleSwap = useCallback(async () => {
    ...
    walletAddress, // Added walletAddress to dependencies
  ])
  ...
  // No longer minimized to an icon, just navigate back
  // if (isMinimized) {
  //   return (
  //     <>
  //       <motion.div
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <motion.div
        ...
        className="bg-gradient-to-br from-gray-50 to-gray-200 backdrop-blur-xl border border-gray-300 rounded-2xl shadow-lg ring-1 ring-gray-200 min-w-[320px] max-w-[380px] overflow-hidden" // Removed fixed positioning
      >
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <button
                    onClick={handleMinimize} // Changed to handleMinimize
                    className="p-1.5 text-gray-600 hover:text-gray-800 transition-colors rounded-lg hover:bg-gray-200"
